    ...
    document
        ...
        .addEventListener("change", function () {
            var e = document.querySelector("#lead-img"),
                t = document.querySelector("#file").files[0],
                a = new FileReader();
            a.addEventListener(
                "load",
                function () {
...
Array.from(tagInputFieldValue).forEach((e, t) => {
    tagHtmlValue +=
        '<span class="badge badge-soft-primary me-1">' + e + "</span>";
}),
    ...
    editBtn.addEventListener("click", function (e) {
        ...
        var t = leadsList.get({ id: idField.value });
        Array.from(t).forEach(function (e) {
            ...
            Array.from(a).forEach((e, t) => {
                l += '<span class="badge badge-soft-primary me-1">' + e + "</span>";
            }),
                t == itemId &&
                e.values({
                    id:
