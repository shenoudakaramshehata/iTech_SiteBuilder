...
{
    public class EditHomeContentModel : PageModel
    {
        ...
        public EditHomeContentModel(CRMDBContext context, IToastNotification toastNotification, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
