...
namespace iTech.Migrations
{
    ...
    [Migration("20230705092719_seddingPublicVideoModelAfterUpdateMig")]
    partial class seddingPublicVideoModelAfterUpdateMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("iTech.Models.PublicVideo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PublicVideoId = 1,
                            Background = "public/img/custom-header-bg.jpg",
