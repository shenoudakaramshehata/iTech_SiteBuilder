...
namespace iTech.Migrations
{
    ...
    [Migration("20230705130332_COuntInfo")]
    partial class COuntInfo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iTech.Models.Count", b =>
                {
                    b.HasOne("iTech.Models.CountInfo", null)
                        .WithMany("counts")
                        .HasForeignKey("CountInfoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("iTech.Models.Count", "counts")
                        .WithMany()
                        .HasForeignKey("countsCountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
